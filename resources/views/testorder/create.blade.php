        ...
        <div class="row">
            ...
            @endif
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('testorder.store')}}" method="POST">
                            {!! csrf_field() !!}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Sample Name</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date" value="{{Carbon\Carbon::today()->toDateString()}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <small style="color:slategrey">*Type Test Item name then press the Add Button</small>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <button type="button" class="btn" id="addOrderTestItemButton">Add Item</button>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
